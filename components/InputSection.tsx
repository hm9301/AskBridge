    ...
    <div className="space-y-4">
      ...
      <div className="relative">
        ...
        <textarea
          ...
          className="w-full p-3 text-sm text-gray-700 bg-gray-50 border border-gray-200 rounded-xl resize-none focus:outline-none focus:ring-2 focus:ring-blue-300 focus:border-transparent placeholder-gray-400 disabled:opacity-50 disabled:cursor-not-allowed transition-all" style={{ height: '120px' }}
        />
