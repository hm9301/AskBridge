      ...
      {!isStreaming && questions.length > 0 && (
        <div className="flex gap-2 pt-2 border-t border-gray-100">
          ...
          <button
            ...
            className="flex-1 flex items-center justify-center gap-1.5 py-2.5 text-xs sm:text-sm text-blue-600 bg-blue-50 hover:bg-blue-100 rounded-lg transition-colors whitespace-nowrap"
          >
            <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
